...
WGPUBufferUsage GetDefaultWGPUBufferUsageForBinding(gl::BufferBinding binding)
{
    switch (binding)
    {
        ...
        case gl::BufferBinding::CopyWrite:
            return WGPUBufferUsage_CopySrc | WGPUBufferUsage_CopyDst;

        case gl::BufferBinding::ShaderStorage:
            return WGPUBufferUsage_Storage | WGPUBufferUsage_CopySrc | WGPUBufferUsage_CopyDst;

        case gl::BufferBinding::DispatchIndirect:
        case gl::BufferBinding::DrawIndirect:
            return WGPUBufferUsage_Indirect | WGPUBufferUsage_CopySrc | WGPUBufferUsage_CopyDst;
